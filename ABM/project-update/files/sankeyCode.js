...
chart.flow().normal().labels().fontColor('black');
	...
	'</div>' +
	'<div class="grid-item gridGraph"><figure><img src="Sankeyplots/Flow/Total/'+ selectedFlow +'.png"/><figcaption>Daily flow during simulation</figcaption></figure></div>' +
	'<div class="grid-item gridGraph"><figure><img src="Sankeyplots/Flow/Age/'+ selectedFlow +'.png"/><figcaption>% daily share by age</figcaption></figure></div>' +
	'<div class="grid-item gridGraph"><figure><img src="Sankeyplots/Flow/Gender/'+ selectedFlow +'.png"/><figcaption>% daily share by sex</figcaption></figure></div>' +
	'</div>'
      ...
      chart
        ...
        .format(function () {
          ...
          if (this.income.length) {
			...
			'<figure><img src="Sankeyplots/In/Total/'+this.name.slice(0, -6) +'.png"/><figcaption>Daily arrivals during simulation</figcaption></figure></div>' +
			'<div class="grid-item gridGraph"><figure><img src="Sankeyplots/In/Age/'+this.name.slice(0, -6) +'.png"/><figcaption>% daily share by age</figcaption></figure></div>' +
			'<div class="grid-item gridGraph"><figure><img src="Sankeyplots/In/Gender/'+this.name.slice(0, -6) +'.png"/><figcaption>% daily share by sex</figcaption></figure></div>' +
			'</div>';
          }
          ...
          if (this.outcome.length) {
			...
			//console.log('<img src="Sankeyplots/Out/Total/'+this.name+'.png"/>');
            tooltip += 'Displaced departures:' + list + '</div>' +
			'<div class="grid-item gridGraph">' +
			'</br><figure><img src="Sankeyplots/Out/Total/'+this.name+'.png"/><figcaption>Daily departures during simulation</figcaption></figure></div>' +
			'<div class="grid-item gridGraph"><figure><img src="Sankeyplots/Out/Age/'+this.name+'.png"/><figcaption>% daily share by age</figcaption></figure></div>' +
			'<div class="grid-item gridGraph"><figure><img src="Sankeyplots/Out/Gender/'+this.name+'.png"/><figcaption>% daily share by sex</figcaption></figure></div>' +
			'</div>';
          }
...
//second argument to match col names
// probably more efficient to make a new array as we load in data and reference that
