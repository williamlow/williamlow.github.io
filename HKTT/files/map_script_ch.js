...
document.querySelector('[name="orig_loc_name"]').value = e_current.chi_name;
document.querySelector('[name="orig_chi_old_date"]').value = e_current.chi_old_date;
...
function onEachFeature(feature, layer) {
    layer.bindPopup('<b>Location: </b>' + feature.properties.chi_name + '<br>' + '<b>Original photo date:</b> ' + feature.properties.chi_old_date + '<br>' + '<b>New photo date:</b> ' + feature.properties.chi_new_date+'<br> <div style="text-align:center;"><button id="myBtn">Submit correction</button></div>',{autoClose: false,closeOnClick:true, autoPan: false});
	layer.on(
        "click",function(e){
